-- /Users/nick/NiCode GmbH/Pommerel/supabase/migrations/20250813000017_add_email_column_to_campaigns.sql
...
ALTER TABLE campaigns ADD COLUMN email TEXT NOT NULL DEFAULT 'reinhard@pommerel.org';
...
BEGIN
    ...
    RAISE NOTICE 'All existing campaigns now have the default email: reinhard@pommerel.org';
END $$;